<script lang="ts">
	...
	let srcToChange = 'https://firebasestorage.googleapis.com/v0/b/greetgenius-3a2eb.appspot.com/o/fdgjdfbgibsd.mp4?alt=media&token=25dc7594-6fe9-4854-9e5c-e8de9cda4686'
	...
	let responseData;
  let audioUrl;
  let textToConvert = 'Merry Christmas!';
  async function fetchData() {
  try {
	showButton = false;
    const apiKey = '09dde1ebc5ca107f9611c9f4c6063515';
    const voiceId = 'b1kND0Oo4lUgXLJkK9FE';
    ...
    reader.onloadend = () => {
      ...
      fetch('https://replicate-ganr.onrender.com/generateImage', {
        ...
        body: JSON.stringify({
          audio: audioDataUri,
          face: 'https://firebasestorage.googleapis.com/v0/b/aiavatars-d061c.appspot.com/o/Untitled%20design(7).mp4?alt=media&token=3cab1851-6551-49f9-8af2-b2476024a7ec',
