<script lang="ts">
	...
	let srcToChange = 'https://firebasestorage.googleapis.com/v0/b/aiavatars-d061c.appspot.com/o/result_voice.mp4?alt=media&token=3581f7c9-6fc8-4720-aea4-c3bfc3af5068'
  ...
  try {
    ...
    reader.onloadend = () => {
      ...
      fetch('https://replicate-ganr.onrender.com/generateImage', {
        ...
        body: JSON.stringify({
          audio: audioDataUri,
          face: 'https://ucarecdn.com/f50824a2-634a-4b62-8c82-5dcce413f2e8/Untitleddesign133.png',
