<script lang="ts">
	...
	let srcToChange = 'https://firebasestorage.googleapis.com/v0/b/aiavatars-d061c.appspot.com/o/fgrrtg.mp4?alt=media&token=43036fbc-4e2a-4921-aa35-3d1ca5bfccae'
	...
	let responseData;
  let audioUrl;
  let textToConvert = 'Ho Ho Ho Merry Christmas!';
  async function fetchData() {
  try {
	showButton = false;
    const apiKey = '09dde1ebc5ca107f9611c9f4c6063515';
    const voiceId = 'QCujVdQ7d1o7Imcu4Wrv';
    ...
    reader.onloadend = () => {
      ...
      fetch('https://replicate-ganr.onrender.com/generateImage', {
        ...
        body: JSON.stringify({
          audio: audioDataUri,
          face: 'https://ucarecdn.com/800641f2-3eb6-49f4-b323-694bea12c157/Untitleddesign132.png',
